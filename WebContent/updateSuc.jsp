...
{
    sql = "SELECT productName, categoryId, productDesc, productPrice from product where productName = ?";
    ...
    else
    {
        ...
        sql = "UPDATE product SET categoryId=?, productDesc=?, productPrice=? WHERE productName = ?";
        PreparedStatement pstmt1 = con.prepareStatement(sql);
        pstmt1.setInt(1,cn);
        pstmt1.setString(2, desc);
        pstmt1.setDouble(3, price);
        pstmt1.setString(4, pn);

        pstmt1.executeUpdate();

        out.println("<h3 style=\"font-size: 40px; position: absolute; top: 47%; left: 34%; z-index: 2; font-family: 'Charm', cursive;\"> The product " + pn + " is successfully updated !</h3>");
